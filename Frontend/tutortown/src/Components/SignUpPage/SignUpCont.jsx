...
function SignUpCont() {
    ...
    const handleTutorQualificationDetails = (e) => {
        ...
        setTutorQualificationDetails({
            ...tutorQualificationDetails, [name] : value
        })
    }
    ...
    const handleTutorVerificationDetails = (e) => {
        ...
        setTutorVerificationDetails({
            ...tutorVerificationDetails, [name] : value
        })
    }
    ...
    const handleImageProfilePicUpload = () => {
        ...
        axios
          ...
          .then((res) => {
            setTutorVerificationDetails({ ...tutorVerificationDetails, profile_pic: res.data.data.link })
            console.log(tutorVerificationDetails);
          })
          .catch((err) => {
              console.log(err);
      ...
      const handleImageAadharPicUpload = () => {
        ...
        axios
          ...
          .then((res) => {
            setTutorVerificationDetails({ ...tutorVerificationDetails, aadhar_pic: res.data.data.link })
            console.log(tutorVerificationDetails);
          })
          .catch((err) => {
            console.log(err);
    ...
    return (
        <div className={styles.sign_up_cont}>
            {tutor === false && student === false ? <div className={styles.select_role}>
                ...
                <form action="" className={styles.form_main} onSubmit={handleQualification}>
                    ...
                    <div className={styles.heading_n_a_g_input}>
                        <input type="text" placeholder="Enter Name" name="full_name" onChange={handleTutorBasicDetails}/>
                        <input type="number" placeholder="Enter Age" name="age" onChange={handleTutorBasicDetails}/>
                        <select name="gender" id="" onChange={handleTutorBasicDetails}>
                    ...
                    <input type="number" placeholder="Mobile Number" name="mobile_number" onChange={handleTutorBasicDetails}/>
                        <input type="email" placeholder="xyz@gmail.com" name="email" onChange={handleTutorBasicDetails}/>
                    </div>
                    ...
                    <div className={styles.s_l_p_input}>
                        <select name="subject" onChange={handleTutorBasicDetails}>
                        ...
                        <select name="location" onChange={handleTutorBasicDetails}>
                        ...
                        <input type="password" name="password" id="" placeholder="Enter Password" onChange={handleTutorBasicDetails}/>
                        <input type="password" name="re_type" placeholder="Re-enter Password" onChange={handleTutorBasicDetails}/> 
                        {tutorbasicDetails.password === tutorbasicDetails.re_type && tutorbasicDetails.password.length > 0 && tutorbasicDetails.re_type.length > 0? <div style={{fontSize:"20px", color:"green", marginLeft:"690px", fontWeight:"900", position:"absolute", zIndex:"-0", marginTop:"-25px"}}>✔</div> : tutorbasicDetails.password.length > 0 ?  <div style={{fontSize:"20px", color:"red", marginLeft:"690px", position:"absolute", marginTop:"-25px"}}>✘</div> : "" }
                    </div>
                    <button type="submit" disabled={(tutorbasicDetails.password.length === 0 && tutorbasicDetails.re_type.length === 0) || tutorbasicDetails.password !== tutorbasicDetails.re_type} type="submit" className={styles.continue_button} className={styles.continue_button}>Continue</button>
                </form>
                ...
                <form action="" className={styles.form_main} onSubmit={handleVerification}>
                    ...
                    <div className={styles.deg_marks_exp_input}>
                        <select name="degree" onChange={handleTutorQualificationDetails}>
                        ...
                        <input type="number" placeholder="Percentage" name="marks" onChange={handleTutorQualificationDetails}/>
                        <select name="experience" onChange={handleTutorQualificationDetails}>
                    ...
                    <div className={styles.skills_input}>
                        <textarea type="text" name="skills" onChange={handleTutorQualificationDetails}/>
                        <textarea type="text" name="description" onChange={handleTutorQualificationDetails}/>
                    </div>
                    <button className={styles.continue_button} disabled={tutorQualificationDetails.description === ""} >Continue</button>
                </form>
                <div className={styles.mandatory}>All feilds are mandatory *</div>
                ...
                <form action="" className={styles.form_main} onSubmit={handleDone}>
                    <div className={styles.heading_deg_marks_exp}>
                        <div>Aadhar Number</div>
                    </div>
                    <div className={styles.deg_marks_exp_input}>
                        <input type="number" placeholder="Enter aadhar number" name="aadhar_number" onChange={handleTutorVerificationDetails}/>
                    </div>
                    ...
                    <div className={styles.address_input}>
                        <textarea type="text" name="current_address" id="01" onChange={handleTutorVerificationDetails} value={tutorVerificationDetails.current_address}/>
                        <textarea type="text" name="permanent_address" id="02" onChange={handleTutorVerificationDetails} value={tutorVerificationDetails.permanent_address}/>
                    </div>
                ...
                <div className={styles.mandatory}>All feilds are mandatory *</div>
            <form action="" className={styles.studen_form_main} onSubmit={handleDone}>
                    <div className={styles.heading_name_age_gender}>
                        <div>Full Name</div>
                        <div>Age</div>
                    ...
                    <div className={styles.heading_n_a_g_input}>
                        <input type="text" placeholder="Enter Name" name="full_name" onChange={handleStudentData}/>
                        <input type="number" placeholder="Enter Age" name="age" onChange={handleStudentData}/>
                        <select name="current_class" onChange={handleStudentData}>
                    ...
                    <div className={styles.mobile_email_input}>
                    <input type="number" placeholder="Mobile Number" name="mobile_number" onChange={handleStudentData}/>
                        <input type="email" placeholder="xyz@gmail.com" name="email" onChange={handleStudentData}/>
                    </div>
                    <div className={styles.heading_add} >
                        Address
                    </div>
                    <div className={styles.add_input}>
                        <textarea name="address" onChange={handleStudentData}></textarea>
                    </div>
                    <div className={styles.heading_student_password}>
                        <div>Password</div>
                        <div style={{marginLeft:"9px"}}>Re-enter Password</div>
                        {studentData.password === studentData.re_type && studentData.password.length > 0 && studentData.re_type.length > 0? <div style={{fontSize:"10px", marginTop:"3.5px", color:"green", marginLeft:"5px", fontWeight:"900"}}>Matched</div> : studentData.password.length > 0 ?  <div style={{fontSize:"10px", marginTop:"3.5px", color:"red", marginLeft:"5px"}}>Not matching with previous password</div> : "" }
                    </div>
                    <div className={styles.s_l_p_input}>
                        <input type="password" name="password" placeholder="Enter Password" onChange={handleStudentData}/>
                        <input type="password" name="re_type" placeholder="Re-enter Password" onChange={handleStudentData}/> 
                    </div>
                    <button disabled={(studentData.password.length === 0 && studentData.re_type.length === 0) || studentData.password !== studentData.re_type} type="submit" className={styles.continue_button}>Submit</button>
                 </form>
